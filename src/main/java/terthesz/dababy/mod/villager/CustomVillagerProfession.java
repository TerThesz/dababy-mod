...
public class CustomVillagerProfession {
  ...
  public static final void addTrades() {
    TradeOffers.PROFESSION_TO_LEVELED_TRADE.put(DABABY, copyToFastUtilMap(ImmutableMap.of(1, new TradeOffers.Factory[]{new TradeOfferFactory.SellItem(DababyMod.COIN, 4, DababyMod.MONEY, 1, 10, 3), new TradeOfferFactory.SellItem(DababyMod.MONEY, 2, DababyMod.REINFORCED_GLASS, 1, 10, 3)}, 2, new TradeOffers.Factory[]{new TradeOfferFactory.BuyItem(DababyMod.AMONG_US_DISC, 1, DababyMod.FULL_SWAG_CAPSULE, 1, 5, 8), new TradeOfferFactory.BuyItem(DababyMod.BURGER_KING_DISC, 1, DababyMod.FULL_SWAG_CAPSULE, 1, 5, 8)}, 3, new TradeOffers.Factory[]{new TradeOfferFactory.BuyItem(DababyMod.BZUM_BZUM_DISC, 1, DababyMod.FULL_SWAG_CAPSULE, 1, 5, 16), new TradeOfferFactory.BuyItem(DababyMod.GAGGING_CAT_DISC, 1, DababyMod.FULL_SWAG_CAPSULE, 1, 5, 16)}, 4, new TradeOffers.Factory[]{new TradeOfferFactory.BuyItem(DababyMod.LETS_GO_DISC, 1, DababyMod.COMPRESSED_FULL_SWAG_CAPSULE, 1, 5, 32), new TradeOfferFactory.BuyItem(DababyMod.PULL_UP_DISC, 1, DababyMod.COMPRESSED_FULL_SWAG_CAPSULE, 1, 5, 32), new TradeOfferFactory.BuyItem(DababyMod.RICK_ROLL_DISC, 1, DababyMod.COMPRESSED_FULL_SWAG_CAPSULE, 1, 5, 32)})));
  }
